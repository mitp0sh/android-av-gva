...
.field private mOnChooseActivityListener:Landroid/support/v7/internal/widget/q;
...
.method private setActivityChooserPolicyIfNeeded()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->mOnChooseActivityListener:Landroid/support/v7/internal/widget/q;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->mOnChooseActivityListener:Landroid/support/v7/internal/widget/q;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ShareActionProvider;->mOnChooseActivityListener:Landroid/support/v7/internal/widget/q;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/k;->a(Landroid/support/v7/internal/widget/q;)V
...
.method public onCreateActionView()Landroid/view/View;
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/internal/widget/s;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/s;->setActivityChooserModel(Landroid/support/v7/internal/widget/k;)V
    ...
    sget v3, Landroid/support/v7/b/c;->actionModeShareDrawable:I
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/s;->setExpandActivityOverflowButtonDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v1, p0}, Landroid/support/v7/internal/widget/s;->setProvider(Landroid/support/v4/view/n;)V

    sget v0, Landroid/support/v7/b/i;->abc_shareactionprovider_share_with_application:I

    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/s;->setDefaultActionButtonContentDescription(I)V

    sget v0, Landroid/support/v7/b/i;->abc_shareactionprovider_share_with:I

    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/s;->setExpandActivityOverflowButtonContentDescription(I)V
...
.method public onPrepareSubMenu(Landroid/view/SubMenu;)V
    ...
    sget v6, Landroid/support/v7/b/i;->abc_activity_chooser_view_see_all:I
...
.method public setShareIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/k;->a(Landroid/content/Intent;)V
