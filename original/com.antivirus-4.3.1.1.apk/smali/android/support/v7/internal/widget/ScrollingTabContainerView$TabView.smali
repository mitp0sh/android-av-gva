...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->a:Landroid/support/v7/a/f;

    invoke-virtual {v0}, Landroid/support/v7/a/f;->c()Landroid/view/View;
    ...
    :cond_5
    invoke-virtual {v0}, Landroid/support/v7/a/f;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {v0}, Landroid/support/v7/a/f;->b()Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v3, v5, v4}, Landroid/support/v7/internal/widget/af;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/a/f;->e()Ljava/lang/CharSequence;
...
.method public a(Landroid/support/v7/a/f;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->a:Landroid/support/v7/a/f;
...
.method a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/a/f;Z)V
    .locals 1
    ...
    iput-object p2, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->a:Landroid/support/v7/a/f;
...
.method public getTab()Landroid/support/v7/a/f;
    .locals 1
