...
# direct methods
.method private a(Ljava/lang/String;Landroid/support/v4/app/av;)Landroid/support/v4/app/av;
    .locals 4
    ...
    invoke-static {v0}, Landroid/support/v4/app/au;->b(Landroid/support/v4/app/au;)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/support/v4/app/au;->a(Landroid/support/v4/app/au;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/av;->b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/av;

    :cond_3
    if-eqz v1, :cond_4

    invoke-static {v1}, Landroid/support/v4/app/au;->a(Landroid/support/v4/app/au;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/au;->c(Landroid/support/v4/app/au;)Ljava/lang/Class;
    ...
    invoke-static {v1}, Landroid/support/v4/app/au;->d(Landroid/support/v4/app/au;)Landroid/os/Bundle;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/app/au;->a(Landroid/support/v4/app/au;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/au;->b(Landroid/support/v4/app/au;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p2, v0, v2, v3}, Landroid/support/v4/app/av;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/av;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/av;->c(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/av;
...
.method protected onAttachedToWindow()V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/app/au;->a(Landroid/support/v4/app/au;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/av;->b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/av;
    ...
    invoke-direct {p0, v3, v1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/av;)Landroid/support/v4/app/av;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/av;)Landroid/support/v4/app/av;
