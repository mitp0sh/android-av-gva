...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-static {p2, p1}, Landroid/support/v4/app/aw;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/app/aw;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/app/bb;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/app/az;-><init>(Landroid/support/v4/app/bb;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/support/v4/app/aw;->b(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v0

    new-instance v1, Landroid/support/v4/app/ax;

    invoke-direct {v1, v0}, Landroid/support/v4/app/ax;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/bc;Landroid/view/View;Landroid/support/v4/app/bb;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 9
    ...
    invoke-static {p1, v0}, Landroid/support/v4/app/aw;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/v4/app/ay;-><init>(Landroid/view/View;Landroid/support/v4/app/bc;Ljava/util/Map;Ljava/util/Map;Landroid/transition/Transition;Ljava/util/ArrayList;)V
    ...
    :cond_3
    invoke-static {v6, p5}, Landroid/support/v4/app/aw;->a(Landroid/transition/Transition;Landroid/support/v4/app/bb;)V
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/app/aw;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/app/aw;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/app/aw;->b(Ljava/util/ArrayList;Landroid/view/View;)V
