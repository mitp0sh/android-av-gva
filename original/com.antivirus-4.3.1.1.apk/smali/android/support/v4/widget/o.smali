...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/o;->d:Ljava/lang/Runnable;

    iput p2, p0, Landroid/support/v4/widget/o;->b:I

    return-void
.end method

.method static synthetic a(Landroid/support/v4/widget/o;)V
    .locals 0

    invoke-direct {p0}, Landroid/support/v4/widget/o;->c()V
...
.method private b()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/widget/o;->a:Landroid/support/v4/widget/DrawerLayout;
...
.method private c()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/o;->c:Landroid/support/v4/widget/ao;

    invoke-virtual {v1}, Landroid/support/v4/widget/ao;->b()I
    ...
    iget-object v3, p0, Landroid/support/v4/widget/o;->c:Landroid/support/v4/widget/ao;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v3, v2, v1, v5}, Landroid/support/v4/widget/ao;->a(Landroid/view/View;II)Z

    iput-boolean v4, v0, Landroid/support/v4/widget/m;->c:Z
...
.method public a()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/o;->d:Ljava/lang/Runnable;
...
.method public a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/o;->c:Landroid/support/v4/widget/ao;

    invoke-virtual {v2}, Landroid/support/v4/widget/ao;->c()Landroid/view/View;
...
.method public a(Landroid/support/v4/widget/ao;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/o;->c:Landroid/support/v4/widget/ao;
...
.method public b(Landroid/view/View;I)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/m;->c:Z
