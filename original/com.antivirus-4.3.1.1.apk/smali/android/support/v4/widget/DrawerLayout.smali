...
# static fields
.field static final a:Landroid/support/v4/widget/i;
...
.field private final d:Landroid/support/v4/widget/h;
...
.field private final i:Landroid/support/v4/widget/ao;

.field private final j:Landroid/support/v4/widget/ao;
...
.field private t:Landroid/support/v4/widget/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/h;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/h;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/o;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/o;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/o;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/o;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/ao;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ar;)Landroid/support/v4/widget/ao;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    invoke-virtual {v1, v3}, Landroid/support/v4/widget/ao;->a(I)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/ao;->a(F)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/o;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/o;->a(Landroid/support/v4/widget/ao;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/ao;->a(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/o;->a(Landroid/support/v4/widget/ao;)V

    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    invoke-static {p0, v3}, Landroid/support/v4/view/av;->b(Landroid/view/View;I)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;Z)V

    invoke-static {p0}, Landroid/support/v4/view/av;->h(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/i;

    invoke-interface {v0, p0}, Landroid/support/v4/widget/i;->a(Landroid/view/View;)V
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/av;->b(Landroid/view/View;I)V
...
.method private f()Z
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/m;->c:Z
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ao;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;

    invoke-virtual {v3}, Landroid/support/v4/widget/ao;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/l;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/l;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/l;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/l;->a(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/m;->c:Z
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/av;->b(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/h;

    invoke-static {p1, v0}, Landroid/support/v4/view/av;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method b(Landroid/view/View;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/widget/m;->d:Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/l;->b(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/l;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/ao;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/ao;->a(Z)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/i;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/ao;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ao;
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/ao;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/ao;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    iget v9, v0, Landroid/support/v4/widget/m;->a:I

    invoke-static {v9, v6}, Landroid/support/v4/view/q;->a(II)I

    move-result v9

    invoke-static {v8}, Landroid/support/v4/view/av;->h(Landroid/view/View;)Z

    move-result v10

    if-eqz v10, :cond_a

    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/i;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v10, v8, v11, v9}, Landroid/support/v4/widget/i;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v9, v0, Landroid/support/v4/widget/m;->leftMargin:I

    sub-int v9, v2, v9

    iget v10, v0, Landroid/support/v4/widget/m;->rightMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/m;->topMargin:I
    ...
    invoke-interface {v10, v0, v11, v9}, Landroid/support/v4/widget/i;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    iget v10, v0, Landroid/support/v4/widget/m;->leftMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/m;->width:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/ao;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/ao;->d(II)Landroid/view/View;
...
.method public setDrawerListener(Landroid/support/v4/widget/l;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/l;
