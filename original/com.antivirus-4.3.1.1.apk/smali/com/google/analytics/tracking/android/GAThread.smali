...
# static fields
.field private static i:Lcom/google/analytics/tracking/android/GAThread;
...
.field private volatile f:Lcom/google/analytics/tracking/android/MetaModel;

.field private volatile g:Ljava/lang/String;

.field private volatile h:Ljava/lang/String;

.field private volatile j:Lcom/google/analytics/tracking/android/ServiceProxy;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
    ...
    :cond_0
    iput-object p1, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
...
.method static a(Landroid/content/Context;)Lcom/google/analytics/tracking/android/GAThread;
    ...
    sget-object v0, Lcom/google/analytics/tracking/android/GAThread;->i:Lcom/google/analytics/tracking/android/GAThread;
    ...
    sput-object v0, Lcom/google/analytics/tracking/android/GAThread;->i:Lcom/google/analytics/tracking/android/GAThread;
...
.method static synthetic a(Lcom/google/analytics/tracking/android/GAThread;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->h:Ljava/lang/String;
...
.method static synthetic a(Lcom/google/analytics/tracking/android/GAThread;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/google/analytics/tracking/android/GAThread;->g:Ljava/lang/String;
...
.method static synthetic a(Lcom/google/analytics/tracking/android/GAThread;Ljava/util/Map;)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/analytics/tracking/android/GAThread;->d(Ljava/util/Map;)Z
...
.method static synthetic a(Lcom/google/analytics/tracking/android/GAThread;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/google/analytics/tracking/android/GAThread;->d:Z
...
.method private a(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
    ...
    invoke-static {v1}, Lcom/google/analytics/tracking/android/Log;->c(Ljava/lang/String;)I
...
.method static b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/google/analytics/tracking/android/Log;->c(Ljava/lang/String;)I
    ...
    invoke-static {v1}, Lcom/google/analytics/tracking/android/Log;->h(Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-static {v1}, Lcom/google/analytics/tracking/android/Log;->d(Ljava/lang/String;)I
    ...
    invoke-static {v2}, Lcom/google/analytics/tracking/android/Log;->d(Ljava/lang/String;)I
    :try_end_1
...
.method private b(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/Utils;->c(Ljava/lang/String;)Z
...
.method static synthetic b(Lcom/google/analytics/tracking/android/GAThread;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/analytics/tracking/android/GAThread;->e(Ljava/util/Map;)V

    return-void
.end method

.method static synthetic b(Lcom/google/analytics/tracking/android/GAThread;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/google/analytics/tracking/android/GAThread;->d:Z
...
.method static synthetic c(Lcom/google/analytics/tracking/android/GAThread;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->g:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic c(Lcom/google/analytics/tracking/android/GAThread;Ljava/util/Map;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/analytics/tracking/android/GAThread;->f(Ljava/util/Map;)V
...
.method private c(Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/Utils;->e(Ljava/lang/String;)[B
    ...
    iget-object v3, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
    ...
    invoke-interface {v2, v1, v0}, Lcom/google/analytics/tracking/android/ExceptionParser;->a(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/String;
...
.method static synthetic d(Lcom/google/analytics/tracking/android/GAThread;)Lcom/google/analytics/tracking/android/MetaModel;
    .locals 1

    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->f:Lcom/google/analytics/tracking/android/MetaModel;

    return-object v0
.end method

.method static synthetic d(Lcom/google/analytics/tracking/android/GAThread;Ljava/util/Map;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/analytics/tracking/android/GAThread;->c(Ljava/util/Map;)V
...
.method private d(Ljava/util/Map;)Z
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/Utils;->b(Ljava/lang/String;)D
...
.method static synthetic e(Lcom/google/analytics/tracking/android/GAThread;Ljava/util/Map;)Ljava/lang/String;
    .locals 1
...
.method static synthetic e(Lcom/google/analytics/tracking/android/GAThread;)Ljava/util/List;
    .locals 1

    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->e:Ljava/util/List;
...
.method private e()V
    ...
    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->j:Lcom/google/analytics/tracking/android/ServiceProxy;
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->f:Lcom/google/analytics/tracking/android/MetaModel;

    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->f:Lcom/google/analytics/tracking/android/MetaModel;

    invoke-static {v0}, Lcom/google/analytics/tracking/android/MetaModelInitializer;->a(Lcom/google/analytics/tracking/android/MetaModel;)V
...
.method private e(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v4, p0, Lcom/google/analytics/tracking/android/GAThread;->k:Landroid/content/Context;
    ...
    invoke-direct {p0, p1, v4, v1}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "appVersion"

    invoke-direct {p0, p1, v1, v0}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "appId"

    invoke-direct {p0, p1, v0, v2}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "appInstallerId"

    invoke-direct {p0, p1, v0, v3}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/google/analytics/tracking/android/Log;->c(Ljava/lang/String;)I
...
.method static synthetic f(Lcom/google/analytics/tracking/android/GAThread;)Lcom/google/analytics/tracking/android/ServiceProxy;
    .locals 1
...
.method private f(Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/Utils;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic g(Lcom/google/analytics/tracking/android/GAThread;)Landroid/content/Context;
    .locals 1
...
.method private g()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/lang/String;)Z
...
.method public a()V
    ...
    invoke-direct {p0, v0}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/lang/Runnable;)V

    return-void
.end method

.method public a(Lcom/google/analytics/tracking/android/AnalyticsThread$ClientIdCallback;)V
    .locals 1
...
.method public a(Lcom/google/analytics/tracking/android/GoogleAnalytics$AppOptOutCallback;)V
    .locals 1
...
.method public a(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v1}, Lcom/google/analytics/tracking/android/GAThread;->a(Ljava/lang/Runnable;)V
...
.method d()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/google/analytics/tracking/android/GAThread;->g()Ljava/lang/String;
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->j:Lcom/google/analytics/tracking/android/ServiceProxy;

    :cond_0
    invoke-direct {p0}, Lcom/google/analytics/tracking/android/GAThread;->e()V

    :try_start_1
    invoke-direct {p0}, Lcom/google/analytics/tracking/android/GAThread;->f()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/analytics/tracking/android/GAThread;->d:Z

    invoke-virtual {p0}, Lcom/google/analytics/tracking/android/GAThread;->d()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->h:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/GAThread;->g:Ljava/lang/String;
    :try_end_1
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/Log;->d(Ljava/lang/String;)I
    :try_end_3
